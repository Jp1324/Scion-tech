		...
		<div class="row fullscreen d-flex align-items-center justify-content-center">
			<div class="banner-content col-lg-12 col-md-12">
				...
				<p class="text-white">
					...
					<br> dolore magna aliqua. Ut enim ad minim. sed do eiusmod tempor incididunt.
				</p>
				<a href="about.php" class="primary-btn header-btn text-uppercase">Get Started</a>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="single-cat d-flex flex-column">
					...
					<h4 class="mb-20" style="margin-top: 23px;">Sales</h4>
					<p>
			...
			<div class="col-lg-4">
				<div class="single-cat">
					...
					<h4 class="mt-40 mb-20">Service</h4>
					<p>
						inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially in the
						workplace. That’s why.
					</p>
			...
			<div class="col-lg-4">
				<div class="single-cat">
					...
					<h4 class="mt-40 mb-20">Maintenance</h4>
					<p>
						inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially in the
						workplace. That’s why.
					</p>
